...
class Marshaller:
    ... depends on your strategy/method ...
    ... for instance, could use unpickle ...
    ... or XML, SOAP, your own format, etc ...

    def pack(self, topic, **args):
        ... pack topic and args into a data string ...
        return data
    def unpack(self, data):
        ... unpack data into a topic and args
...
class AppListener:
    def __init__(self, server, readPort, maxWait=0.01): 
        ...
        self.__udpSocket = socket(...server...)
        self.__udpSocket.bind(...readPort...)
...
class PubsubAppServer:
    ...
    def __init__(self):
        ...
        self.__udpSocket.bind(...SERVER_PORT...)
